    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            Text('List Stock Barang', style: TextTheme.of(context).titleMedium),
            IconButton(onPressed: () {}, icon: Icon(Icons.search_rounded, size: 24)),
          ],
        ),
      ),
      body: SafeArea(
                ...
                children: [
                  Obx(
                    () => Column(
                      ...
                      children: [
                        Text('Total Stok'),
                        Text('${barangController.totalStok.value}', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16)),
                      ],
                    ),
                  ),
                  Obx(
                    () => InkWell(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text('Total Harga'),
                          Text(formatCurrency(barangController.totalHarga.value), style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16)),
                        ],
                      ),
                    ),
                  ),
                  ...
                  child: PagingListener(
                    ...
                    builder: (context, state, fetchNextPage) => PagedListView<int, Barang>(
                      ...
                      builderDelegate: PagedChildBuilderDelegate(
                        firstPageErrorIndicatorBuilder: (context) => Center(child: Text('Terjadi Kesalahan')),
                        noItemsFoundIndicatorBuilder: (context) => Center(child: Center(child: Text('Data Kosong'))),
                        newPageErrorIndicatorBuilder: (context) => Center(child: Text('Terjadi Kesalahan')),
                        noMoreItemsIndicatorBuilder: (context) => Center(
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Icon(Icons.arrow_upward_rounded, color: Colors.grey, size: 16),
                                SizedBox(width: 4),
                                Text('Tarik untuk memuat data lainnya', style: Theme.of(context).textTheme.bodySmall?.copyWith(color: Colors.grey)),
                              ],
                            ),
                          ),
                        ),
                        itemBuilder: (context, item, index) => Container(
                          ...
                          decoration: BoxDecoration(
                            color: Colors.white,
                            border: BoxBorder.fromSTEB(bottom: BorderSide(color: Colors.black)),
                            boxShadow: [
                              BoxShadow(
                          ...
                          child: ListTile(
                            ...
                            trailing: Text(
                              ...
                              style: Theme.of(context).textTheme.titleMedium?.copyWith(color: Colors.black, fontSize: 14, fontWeight: FontWeight.w500),
                            ),
                          ),
                        ),
                      ),
